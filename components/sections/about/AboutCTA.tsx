...
interface AboutCTAProps {
  data?: SanityAboutPage["ctaSection"];
}
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
              {data?.heading || "Ready to Switch to Solar?"}
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                ...
                {data?.primaryCtaText || "Contact Us"}
              </Link>
              <Link
              ...
              >
                {data?.secondaryCtaText || "View Projects"}
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>

            <p className="mt-8 text-sm text-green-200/80 font-medium whitespace-pre-line">
              {data?.footnote ||
